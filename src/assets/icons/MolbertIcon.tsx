...
interface MolbertIconProps {
  className?: string;
  size?: number;
}

export const MolbertIcon = ({ className, size = 200 }: MolbertIconProps) => {
  const brandBlue = "rgb(0, 117, 213)";
  ...
  return (
    <svg
      ...
      className={className}
      style={{ filter: `drop-shadow(0 0 10px ${brandBlue}55)` }}
    >
      <defs>
        <linearGradient
          id="molbert-blue-grad"
          x1="0%"
          y1="0%"
          x2="0%"
          y2="100%"
        >
          <stop offset="0%" stopColor="rgb(30, 150, 255)" />
          <stop offset="100%" stopColor={brandBlue} />
        </linearGradient>
      </defs>

      <g
        fill="url(#molbert-blue-grad)"
        stroke="url(#molbert-blue-grad)"
        strokeWidth="1"
        strokeLinecap="round"
      ...
      >
        <g>
          <path
            d="M394.717,75.189H117.284c-4.498,0-8.143,3.645-8.143,8.143V229.98c0,4.498,3.645,8.143,8.143,8.143h36.615
        ...
        <g>
          <path
            d="M436.638,311.743c15.808,0,28.667-12.86,28.667-28.667s-12.86-28.667-28.667-28.667h-1.204V50.758
